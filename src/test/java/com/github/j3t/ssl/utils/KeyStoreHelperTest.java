...
public class KeyStoreHelperTest {
    ...
    @Test(expected = IllegalStateException.class)
    public void toStringShouldThrowExceptionWhenKeyStoreIsNotInitialized() throws Exception {
    ...
    @Test(expected = IllegalStateException.class)
    public void toStringByAliasShouldThrowExceptionWhenKeyStoreIsNotInitialized() throws Exception {
